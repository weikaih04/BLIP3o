...
for v in MAX_STEPS PER_GPU_BS EFF_BS WORKERS REPORT_TO SAVE_STEPS SAVE_KEEP LR \
         UNFREEZE_GEO GEO_LOSS_W SHAPE_INIT TEX_INIT MIX DINO_DROP QWEN_DROP \
         ...
         GC ELASTIC ELASTIC_RATIO DEEPSPEED ADAPTIVE_CLIP \
         PYTORCH_CUDA_ALLOC_CONF MISMATCH_W MISMATCH_MARGIN \
         GEOTEX_IM_TOK_PER_VIEW JOINT_COND_DROP COND_VLM_CKPT \
         SS_INIT SS_LOSS_W P_SOLO P_LAG K0_LO K0_HI COND_SEG PATCH_POS PATCH_LATTICE \
         EXTRA_ARGS; do
