...
MANIFEST=/fsx/sfr/weikaih/3dgen/data/trellis2/manifests/ready_v3/ready_v3_needcache.jsonl
OUT_ROOT=/fsx/sfr/weikaih/3dgen/data/vlm_hidden_cache/qwen35-2b_tok1024_crop_mv1
NSHARD="${NSHARD:-16}"
LOGD=runs/cache_logs/v3fast
mkdir -p "$LOGD"
echo "[v3cache] NSHARD=$NSHARD (GPU=i%8) manifest=$(basename "$MANIFEST")"
