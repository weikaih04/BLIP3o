#!/usr/bin/env bash
# Setup B — codebook + image_block hidden slice (BLIP3o-NEXT style)
set -euo pipefail
NPROC="${1:-8}"
DATA_PATH="${2:-data/index_setup_BC.jsonl}"
